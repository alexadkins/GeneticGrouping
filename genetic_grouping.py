...
# All per-semester settings live in config.py - see that file to change
# anything (weights, generations, mutation strategy, etc). Star-imported
# (not `import config as cfg`) since the rest of this file already
# references these values by bare name throughout.
from config import *
